...
NOTE: Look for "maximum=0" in components defintions. That line defines which components are removed from the model (i.e., not allowed to be built). 
      To run the full model, set "maximum=None" for all components. Else, delete the "maximum=0" line for the components you want to include, and keep it for the ones you want to exclude.
'''
...
# SCENARIO DEFINITION
# =============================================================================
SCENARIO_NAME = "FINAL_MODEL_REMOVE_COMPONENTS"   # ← change per run
