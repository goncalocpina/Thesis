...
SCENARIO_NAME = "NO_CAVERN"   # ← change per run
...
wind = solph.components.Source(
    ...
    outputs={bus_electricity: solph.Flow(
        ...
        nominal_value=solph.Investment(
                ...
                minimum = WIND_OPTIMAL* scaling,
                maximum = WIND_OPTIMAL* scaling,   
                existing=0,
            ),
...
energysystem.add(bus_electricity, bus_H2, pv, wind, electrolyser, H2Demand, battery, electricity_curtailement)
...
# Save figure
plt.tight_layout()
func.savefigure(fig, "H2_BATTERY_monthly_flows")
plt.show()
...
plt.tight_layout()
func.savefigure(fig, "H2_BATTERY_sample_week_dispatch")
plt.show()
...
plt.tight_layout()
func.savefigure(fig, "H2_BATTERY_load_duration_curve")
plt.show()
...
plt.tight_layout()
func.savefigure(fig, "H2_BATTERY_battery_soc_year")
plt.show()
...
ax.xaxis.set_major_formatter(mdates.DateFormatter("%b"))
plt.tight_layout()
func.savefigure(fig, "H2_BATTERY_saltcavern_soc_year")
plt.show()
...
ax.axis('equal')
func.savefigure(fig, "H2_BATTERY_fixed_costs_pie")
...
ax.axis('equal')
func.savefigure(fig, "H2_BATTERY_total_costs_pie")
plt.show()
...
func.savefigure(fig, "H2_BATTERY_lcoh2_instantaneous")
plt.show()
...
func.savefigure(fig, "H2_BATTERY_replacement_cost_overhead")
plt.show()
...
func.savefigure(fig, "H2_BATTERY_npv_evolution")
plt.show()
